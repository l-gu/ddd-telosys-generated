...
public class CatalogRestResponse extends AbstractRestResponse<CatalogRestDto> {
     ...
     * @param pageSize
     */
    public CatalogRestResponse(List<CatalogRestDto> list, long totalElements, int pageSize) {
