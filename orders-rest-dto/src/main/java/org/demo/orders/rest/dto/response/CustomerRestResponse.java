...
public class CustomerRestResponse extends AbstractRestResponse<CustomerRestDto> {
     ...
     * @param pageSize
     */
    public CustomerRestResponse(List<CustomerRestDto> list, long totalElements, int pageSize) {
